...
namespace MYVCApp.Contexts
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<Locationphone> Locationphones { get; set; } = null!;
        public virtual DbSet<Logemail> Logemails { get; set; } = null!;
        public virtual DbSet<Payment> Payments { get; set; } = null!;
        public virtual DbSet<Personnel> Personnel { get; set; } = null!;
        public virtual DbSet<Personnellocation> Personnellocations { get; set; } = null!;
        public virtual DbSet<Secondaryfamilymember> Secondaryfamilymembers { get; set; } = null!;
        public virtual DbSet<Session> Sessions { get; set; } = null!;
        public virtual DbSet<Teamformation> Teamformations { get; set; } = null!;
        public virtual DbSet<Teammember> Teammembers { get; set; } = null!;
        public virtual DbSet<Teamsession> Teamsessions { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Clubmember>(entity =>
            {
                ...
                entity.HasIndex(e => e.MedCardNum, "med_card_num")
                    .IsUnique();

                entity.HasIndex(e => e.SocialSecNum, "social_sec_num")
                    .IsUnique();
            ...
            {
                entity.HasKey(e => new { e.LocationIdFk, e.FamilyMemberIdFk, e.StartDate })
                    .HasName("PRIMARY");
            ...
            {
                entity.HasKey(e => new { e.LocationIdFk, e.PhoneNumber })
                    .HasName("PRIMARY");
            ...
            {
                entity.HasKey(e => new { e.Recipient, e.DeliveryDateTime })
                    .HasName("PRIMARY");
            ...
            {
                entity.HasKey(e => new { e.PrimaryFamilyMemberIdFk, e.FirstName, e.LastName })
                    .HasName("PRIMARY");
            ...
            {
                entity.HasKey(e => new { e.TeamFormationIdFk, e.CmnFk })
                    .HasName("PRIMARY");
            ...
            {
                entity.HasKey(e => new { e.TeamFormationIdFk, e.SessionIdFk })
                    .HasName("PRIMARY");
