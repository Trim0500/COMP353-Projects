...
VALUES ('Cotton', 'Joe', '2012-10-03', 'Gegagedigedagedago@yahoo.com', 157.48, 160.00, '437022223', '648492359553', '5147585160', 'Montreal', 'QC', 'H3H2P2', '6354 Boardfish Road', 'Needs to lose weight', 1, 3, 'nephew', 'nephew'),
       ...
       ('Émilie', 'Chartrand', '2012-09-25', 'emilie.chartrand@example.com', 150.40, 110.00, '223567890', '234567890123', '5145552233', 'Montreal', 'QC', 'H3C2B5', 'Quick reflexes but needs power.', 0, 5, 'niece', 'granddaughter'),
       ('Antoine', 'Desrosiers', '2008-02-17', 'antoine.desrosiers@example.com', 170.12, 160.50, '334678901', '345678901234', '5145553344', 'Montreal', 'QC', 'H4A3C6', 'Strong attacker, improving technique.', 0, 3, 'nephew', 'nephew'),
       ('Camille', 'Fournier', '2011-11-03', 'camille.fournier@example.com', 155.11, 120.22, '445789012', '456789012345', '5145554455', 'Montreal', 'QC', 'H2X4D7', 'Excellent defense, needs serve work.', 0, 2, 'daughter', 'niece'),
       ('Mathis', 'Lavoie', '2006-04-29', 'mathis.lavoie@example.com', 180.10, 175.59, '556890123', '567890123456', '5145555566', 'Montreal', 'QC', 'H1Y5E8', 'All-rounder, great blocking skills.', 0, 7, 'cousin', 'cousin'),
       ('Sophie', 'Pelletier', '2009-07-19', 'sophie.pelletier@example.com', 162.91, 130.83, '667901234', '678901234567', '5145556677', 'Montreal', 'QC', 'H3T6F9', 'Developing spiker, solid stamina.', 0, 4, 'niece', 'granddaughter'),
       ('Noah', 'Gauthier', '2013-01-08', 'noah.gauthier@example.com', 145.00, 100.00, '778012345', '789012345678', '5145557788', 'Montreal', 'QC', 'H3Z7G0', 'Young player with great potential.', 0, 6, 'son', 'grandson'),
       ('Isabelle', 'Morin', '2005-12-14', 'isabelle.morin@example.com', 172.00, 150.00, '889123456', '890123456789', '5145558899', 'Montreal', 'QC', 'H4G8H1', 'Smart playmaker, solid court awareness.', 0, 9, 'cousin', 'cousin'),
       ('Gabriel', 'Côté', '2014-05-30', 'gabriel.cote@example.com', 138.00, 90.00, '990234567', '901234567890', '5145559900', 'Montreal', 'QC', 'H5H9J2', 'Promising skills, needs experience.', 0, 8, 'son', 'grandson'),
       ('Chloé', 'Bouchard', '2007-08-11', 'chloe.bouchard@example.com', 160.67, 125.15, '101345678', '012345678901', '5145551011', 'Montreal', 'QC', 'H3B0K3', 'Fast reactions, improving accuracy.', 0, 10, 'daughter', 'granddaughter'),
       ('William', 'Dubois', '2011-06-23', 'william.dubois@example.com', 158.52, 135.00, '212456789', '123456789012', '5145552122', 'Montreal', 'QC', 'H2X1L4', 'Consistent serves, needs mobility.', 0, 2, 'nephew', 'nephew'),
       ('Élodie', 'Roy', '2004-03-17', 'elodie.roy@example.com', 178.00, 165.90, '323567890', '234567890123', '5145553233', 'Montreal', 'QC', 'H3C2M5', 'Great vertical jump, strong in defense.', 0, 3, 'cousin', 'cousin'),
       ('Thomas', 'Lévesque', '2015-09-09', 'thomas.levesque@example.com', 140.31, 95.63, '434678901', '345678901234', '5145554344', 'Montreal', 'QC', 'H4A3N6', 'Energetic but lacks discipline.', 0, 1, 'nephew', 'nephew'),
       ('Léa', 'Bélanger', '2010-10-20', 'lea.belanger@example.com', 168.00, 145.12, '545789012', '456789012345', '5145555455', 'Montreal', 'QC', 'H5A4P7', 'Balanced skill set, improving leadership.', 0, 5, 'niece', 'granddaughter');
