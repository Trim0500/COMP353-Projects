...
VALUES
    ...
    (4, "MYVC Brossard", "Brossard", "J4W1M9", "Branch", "7250 Taschereau Blvd", "QC", 275, "myvc.ca/location/brossard"),
    (5, "MYVC Toronto", "Toronto", "M1L2L1", "Branch", "1880 Eglinton Ave E", "ON", 400, "myvc.ca/location/toronto"),
    (6, "MYVC Brampton", "Brampton", "L6Y1N7", "Branch", "499 Main Street South", "ON", 300, "myvc.ca/location/brampton"),
